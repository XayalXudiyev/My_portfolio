...
import OTPform from "../assets/Portfolioİmg/otpform.png";
...
const Portfolio = () => {
  const portfolios = [
    ...
    },
    {
      id: 6,
      src: OTPform,
      codeUrl: "https://github.com/xayalxudiyev/OTP-Verificitaion-Form",
      demoUrl: "https://xayalxudiyev.github.io/OTP-Verificitaion-Form/",
    },
  ];
