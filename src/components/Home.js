        ...
        <div className="flex flex-col justify-center h-full mt-20 ">
          ...
          <div class="flex justify-center items-center ">
            <Link
              ...
              smooth
              duration={500}
              className="group text-white w-fit px-6 py-3 my-4 flex items-center justify-center rounded-md bg-gradient-to-r from-cyan-500 to-blue-500 cursor-pointer pl"
            >
              Portfolio
